...
DIALOGUE = function(c) {
    ...
    config.notificationBase =
        Y.Node.create('<div class="'+CSS.BASE+'">')
              .append(Y.Node.create('<div id="'+id+'" role="dialog" aria-labelledby="'+id+'-header-text" aria-describedby="'+id+'-body-text"  class="'+CSS.WRAP+'"></div>')
              .append(Y.Node.create('<div id="'+id+'-header-text" class="'+CSS.HEADER+' yui3-widget-hd"></div>'))
              .append(Y.Node.create('<div id="'+id+'-body-text" class="'+CSS.BODY+' yui3-widget-bd"></div>'))
