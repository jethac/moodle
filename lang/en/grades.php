...
$string['droplow_help'] = 'This setting enables a specified number of the lowest grades to be excluded from the aggregation. Only allowed when items in this category are equally weighted.';
...
$string['keephigh_help'] = 'If set, this option will only keep the X highest grades, X being the selected value for this option. Only allowed when items in this category are equally weighted.';
