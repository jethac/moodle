...
if ($book->navstyle) {
    ...
    if ($previd) {
        ...
        if ($book->navstyle == 1) {
            $chnavigation .= '<a title="' . $navprev . '" href="view.php?id=' . $cm->id . '&amp;chapterid=' . $previd .  '">' .
    ...
    if ($nextid) {
        ...
        if ($book->navstyle == 1) {
            $chnavigation .= '<a title="' . $navnext . '" href="view.php?id=' . $cm->id . '&amp;chapterid='.$nextid.'">' .
        ...
        if ($book->navstyle == 1) {
            $chnavigation .= '<a title="' . $navexit . '" href="'.$returnurl.'">' .
